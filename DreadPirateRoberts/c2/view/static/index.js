...
/**
 * Sites that link to forgetfulelephant.net may specify `target='_blank'` to open the
 ...
 * different origin links to forgetfulelephant.net with `target='_blank'`.
 */
...
function registerProtocolHandlers () {
  ...
  protocolWhitelist.forEach(proto => {
    navigator.registerProtocolHandler(proto, handlerUrl, 'Forgetful Elephant')
  })
}
    ...
    const createCredentialDefaultArgs = {
      ...
      // Relying Party (a.k.a. - Service):
        ...
        user: {
          ...
          name: 'YOU_ARE_HACKED@FORGETFULELEPHANT.NET',
...
function copySpamToClipboard () {
  const randomArt = getRandomArrayEntry(ART) + '\nCheck out https://forgetfulelephant.net'
